      ...
      <div class="col-12 col-xl-11 mx-auto mb-30">
        <div class="about-content text-center">
          <div class="about-left-image mb-30">
            <img src="view/assets/img/blog-post/5-2.png" alt="img" class="img-responsive" />
          </div>
          <div>
            ...
            <img src="view/assets/img/blog-post/signature.png" alt="" />
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-sm-6 py-3">
          <div class="d-flex static-media2 flex-column flex-sm-row">
            <img class="align-self-center mb-2 mb-sm-0 me-auto me-sm-3" src="view/assets/img/icon/2.png" alt="icon" />
        ...
        <div class="col-lg-3 col-sm-6 py-3">
          <div class="d-flex static-media2 flex-column flex-sm-row">
            <img class="align-self-center mb-2 mb-sm-0 me-auto me-sm-3" src="view/assets/img/icon/3.png" alt="icon" />
            <div class="media-body">
        ...
        <div class="col-lg-3 col-sm-6 py-3">
          <div class="d-flex static-media2 flex-column flex-sm-row">
            <img class="align-self-center mb-2 mb-sm-0 me-auto me-sm-3" src="view/assets/img/icon/5.png" alt="icon" />
            <div class="media-body">
        ...
        <div class="col-lg-3 col-sm-6 py-3">
          <div class="d-flex static-media2 flex-column flex-sm-row">
            <img class="align-self-center mb-2 mb-sm-0 me-auto me-sm-3" src="view/assets/img/icon/4.png" alt="icon" />
            <div class="media-body">
      ...
      <div class="col-sm-6 col-lg-4 mb-4">
        <div class="single-blog">
          <div class="single-thumb mb-25 zoom-in d-block overflow-hidden">
            <img src="view/assets/img/service/1.jpg" alt="single-thumb-naile" />
          </div>
      ...
      <div class="col-sm-6 col-lg-4 mb-4">
        <div class="single-blog">
          <div class="single-thumb mb-20 zoom-in d-block overflow-hidden">
            <img src="view/assets/img/service/2.jpg" alt="single-thumb-naile" />
          </div>
          <div class="single-service">
